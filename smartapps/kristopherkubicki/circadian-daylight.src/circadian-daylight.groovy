...
preferences {
    ...
    section("Init Circadian Daylight when the following switches are tured on:") {
        input "initswitches","capability.switch", title: "Switches", multiple:true, required: false
    }
...
private def initialize() {
    ...
    if(initswitches) { subscribe(initswitches, "switch.on", modeHandler) }
